...
public class SimpleController_UsingPlayerInput : MonoBehaviour
{
    ...
    private void Move(Vector2 direction)
    {
        ...
        //Flying move! transform.position += Camera.main.transform.forward * 2f * Time.deltaTime;

        Vector3 va = Camera.main.transform.forward;
        va.y = 0;

        transform.position += va * 2f * Time.deltaTime;
